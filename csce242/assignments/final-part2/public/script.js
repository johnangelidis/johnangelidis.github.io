...
function getBookItem(book){
    ...
    btnElem.classList.add("btn-edit");
    btnElem.innerHTML = `<i class="fas fa-highlighter"></i>`
    btnElem.setAttribute("data-id", book._id);
    btnElem.onclick = showBookDetails;


    let btnElem2 = document.createElement("button");
    btnElem2.classList.add("btn-delete");
    btnElem2.innerHTML = `<i class="fas fa-trash"></i>`;
    btnElem2.onclick = deleteBook;
    
    let br0 = document.createElement("br");
    bookSection.append(h3Elem);
    bookSection.append(br0);

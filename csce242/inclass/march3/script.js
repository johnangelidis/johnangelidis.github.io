...
window.onload = function(){
    let dog = [];
    dog.push(new Dog("Tipsy", "Yorkie", "brown", 5, "small", "yorkie.jpg"));
    dog.push(new Dog("Fred", "Golden Retriever", "brown", 5, "small", "golden-retriever.jpg"));
    dog.push(new Dog("Gerald", "Pit Bull", "brown", 5, "small", "pitbull.jpg"));
    let dogListDiv = document.getElementById("dog-list");

    for(let i in dog){
        dogListDiv.append(dog[i].item);
    }
}